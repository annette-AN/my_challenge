...
function get_email_info(hotel) {
    let data = {hotel: hotel};
    return new Promise(function(resolve, reject) {
...
function set_email_info(hotel, email) {
    console.log(email);
    let data = {hotel: hotel, email: email};
    return new Promise(function(resolve, reject) {
